...
Ένα παράδειγμα προβλήματος που μπορεί να προκύψει από την ανάθεση σημασιολογικών ρόλων είχε παρουσιαστεί στη \fref{lst:srl}.
...
% whisper -> talk
% βοηθητική πρόθεση \intent{Transition}
